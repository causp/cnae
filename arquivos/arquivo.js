function MultiSelectTag1(e, t = { shadow: !1, rounded: !0 }) {
    var l = null,
        n = null,
        a = null,
        d = null,
    ...
    function g(e, t, l = !1) {
        ...
        l && (n.style.backgroundColor = h.bgColor, a.checked = !0);
    }
    ...
    function L() {
        for (var e of p.children) {
            e.addEventListener("click", (e => {
                !1 === n.find((t => t.value == e.target.dataset.value)).selected
                    ? (n.find((t => t.value == e.target.dataset.value)).selected = !0, c.value = null, f(), E())
                    : (n.find((t => t.value == e.target.dataset.value)).selected = !1, c.value = null, f(), E(), w(e.target.dataset.value));
            }));
        }
    }
    ...
    function E(e = !0) {
        ...
        for (var a = 0; a < n.length; a++) {
            ...
            n[a].selected && selected_values.push({ label: n[a].label, value: n[a].value });
        }
    ...
    (function () {
        ...
        l.nextSibling ? l.parentNode.insertBefore(a, l.nextSibling) : l.parentNode.appendChild(a);
    })();
...
function MultiSelectTag2(e, t = { shadow: !1, rounded: !0 }) {
    var l = null,
        n = null,
        a = null,
        d = null,
...
function MultiSelectTag3(e, t = { shadow: !1, rounded: !0 }) {
    var l = null,
        n = null,
        a = null,
        d = null,
